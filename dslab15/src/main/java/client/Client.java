...
public class Client implements IClientCli, Runnable {
	...
	public String msg(String username, String message) throws IOException {
		...
		if(response.contains(":")){
			...
			TcpChannel privateTcp = new TcpChannel();
			...
			response = username+" replied with "+privateTcp.read();
			privateTcp.close();
		}
		return response;
	}
	...
	public String register(String privateAddress) throws IOException {
		...
		if(response.equals("Successfully registered address for "+user+".")){
				...
				PrivateServerListener psListener = new PrivateServerListener(privateServerSocket,shell);
